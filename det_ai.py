    ...
    def next_move(self, response):
        ...
        if response[0] == 0:
            ...
            if self.seeking == True:
                orig_coord = self.get_next_coord_in_direction(self.last_shot,
                                                              self.get_opposite_direction(self.shooting_direction))
                ...
                if self.is_valid_shot(coord_in_orthogonal_dir):
                    ...
                    coord_in_other_orthogonal_dir = self.get_next_coord_in_direction(orig_coord,
                                                                                     other_rand_orthogonal_dir)
